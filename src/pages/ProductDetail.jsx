  ...
  return (
    <div>
      <div className="flex gap-5 items-start my-20">
        <img
          src={product?.image}
          className="w-96 border-2 shadow-lg p-10"
          alt=""
        />
        <div className="flex flex-col gap-5 mt-5">
          <p className="bg-secondary text-info font-semibold px-2 py-1 text-xs rounded-full w-40 text-center">
            {product?.category}
          </p>
          ...
          <p className="text-header font-semibold">$ {product?.price}</p>
          <div className="">
            <button
              onClick={() =>
